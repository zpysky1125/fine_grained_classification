...
class GlimpseNetwork(object):
    def __init__(self, img_size, pth_size, loc_dim, g_size, l_size, output_size, vgg16_npy_path=None, dropout=0.5):
    ...
    def __call__(self, imgs_ph, locs, train_mode=None, init=False):
        ...
        g = self.patch_feature_extractor_2(rgb, train_mode)
        # return tf.nn.relu(g)
    ...
    def get_var(self, initial_value, name, idx, var_name):
        ...
        return tf.Variable(value, name=var_name, trainable=True)
